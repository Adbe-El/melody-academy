...
- [ ] 0.6 Add mobile menu slide transition
  - Replace conditional render with CSS transition on `max-height` + `opacity`
  - Files: `Navbar.tsx`
  - Depends on: —
  - Effort: S

- [ ] 0.7 Install framer-motion + page transitions
...
- [ ] 1.3 Supabase client + auth service
...
- [ ] 1.5 Auth pages (Login, Signup, Forgot Password)
  - Create 3 auth pages, implement Supabase auth flow, create route guards
  - Files: NEW `pages/auth/Login.tsx`, `Signup.tsx`, `ForgotPassword.tsx`, NEW `routes/guards.tsx`
  - Depends on: 1.2, 1.3
  - Effort: M
...
- [ ] 2.2 Programme listing + Programme Details page
...
- [ ] 2.4 Instrument shop + Instrument Details page
...
- [ ] 2.5 Consultancy + Contact refactor
...
- [ ] 3.1 4-step consultation wizard
  ...
  - Files: NEW `components/common/ConsultationWizard.tsx`, `routes/index.tsx`
  - Depends on: 1.2, 1.4
  - Effort: L

- [ ] 3.2 Become an Instructor page
  - Add Requirements, Benefits, FAQ sections above existing form. File upload to Supabase Storage.
  - Files: `pages/recruitment/ApplyInstructor.tsx` refactor, `services/storage.ts`
  - Depends on: 1.2, 1.3
  - Effort: M

- [ ] 3.3 Instructors directory refactor
...
- [ ] 3.4 Admin consultation pipeline
  ...
  - Files: `pages/admin/ConsultationManagement.tsx` (NEW or refactor from AdminDashboard)
  - Depends on: 1.2, 1.3
  - Effort: M
...
- [ ] 5.3 Learner & LMS management
  ...
  - Files: NEW `pages/admin/LearnerManagement.tsx`
  - Depends on: 1.2, 1.3
  - Effort: L
...
- [ ] 5.5 Consultancy request management
  ...
  - Files: NEW `pages/admin/ConsultancyManagement.tsx`
  - Depends on: 1.2, 1.3
  - Effort: M
...
- [ ] 6.3 Website CMS
  ...
  - Files: NEW `pages/admin/WebsiteCMS.tsx`
  - Depends on: 1.2, 1.3
  - Effort: L
...
- [ ] 6.5 Settings + Announcements
  ...
  - Files: NEW `pages/admin/Settings.tsx`, NEW `pages/admin/Announcements.tsx`
  - Depends on: 1.2, 1.3
  - Effort: M
