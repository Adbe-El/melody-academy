...
export const Instruments: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
      ...
      {/* Header Banner */}
      <div className="bg-academy-emerald rounded-3xl p-8 sm:p-12 text-white text-center space-y-3 relative overflow-hidden shadow-xl">
        <span className="text-xs font-bold uppercase tracking-wider bg-white/10 text-academy-gold px-3.5 py-1 rounded-full border border-white/10">
          Official Instrument Shop
        </span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {filteredInstruments.map(inst => (
          <div
            key={inst.id}
            className="bg-white rounded-3xl overflow-hidden border border-gray-200/80 hover:border-academy-emerald/30 hover-lift flex flex-col justify-between p-4"
          >
            <div>
              {/* Image */}
